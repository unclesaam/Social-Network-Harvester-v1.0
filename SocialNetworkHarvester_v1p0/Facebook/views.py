...
def facebookBase(request):
	return render_to_response('facebook/FacebookBase.html')
...
def ajaxFbUserTable(request, aspiraUserId):
	response = {"aaData": [["","Sol Zanetti","sol.zanetti.3","None","None"  ],["","Option nationale","OptionNationale.QC","32086","Option nationale est un parti politique dont l'objectif est de réaliser l'indépendance du Québec.\n\nLe chef d'Option nationale est monsieur Sol Zanetti"  ],["","Andrés Fontecilla","AFontecillaQS","2175","Co-porte-parole et président de Québec solidaire."  ],["","Françoise David","FrancoiseDavid.QS","49893","Députée de Gouin et porte-parole Québec solidaire. Les mises à jour et interventions sur cette page sont faites par Julien R., Marilyn O. et Jérémie B.W."  ],["","Québec solidaire","Quebecsolidaire","65124","Québec solidaire est un parti politique québécois. Son programme défend une vision écologiste, progressiste, démocrate, féministe, altermondialiste, pluraliste et souverainiste pour l'avenir du Québec."  ],["","François Legault","FrancoisLegaultPageOfficielle","17798","Député de l'Assomption et chef de la Coalition Avenir Québec - Suivez l'actualité de la CAQ sur www.lacaq.org Retrouvez moi aussi sur www.twitter.com/francoislegault"  ],["","Coalition Avenir Québec","coalitionavenir","31083","Plus d’autonomie pour le Québec, une économie plus forte et une meilleure éducation pour nos enfants, c’est aujourd’hui possible !"  ],["","Pauline Marois","Pauline-Marois","208","None"  ],["","Parti Québécois","lepartiquebecois","165749","Le Parti Québécois a comme objectif la souveraineté du Québec.  Joignez-vous à nous!\n\nCette page respecte notre nétiquette: http://pq.org/netiquette/"  ],["","Philippe Couillard","phcouillard","31280","Philippe Couillard est premier ministre du Québec. Ce compte est officiel et animé par l'équipe des communications."  ],["","Parti libéral du Québec","LiberalQuebec","37490","Depuis près de 150 ans, le PLQ est le parti de tous les Québécois.\n\nRèglement ? clic.plq.org/nétiquette-PLQ\n\nContactez-nous ? clic.plq.org/contact-PLQ"  ]]}
